...
_$PlotDataModelImpl _$$PlotDataModelImplFromJson(Map<String, dynamic> json) =>
    _$PlotDataModelImpl(
      axis: json['axis'] == null
          ? null
      ...
      customerPoints:
          (json['customer_points'] as List<dynamic>?)
              ?.map(
                (e) => CustomerPointModel.fromJson(e as Map<String, dynamic>),
              )
              .toList() ??
          [],
      decisionBoundary:
          (json['decision_boundary'] as List<dynamic>?)
              ?.map(
                (e) =>
                    DecisionBoundaryModel.fromJson(e as Map<String, dynamic>),
              )
              .toList() ??
          [],
      ...
      predictionRegions:
          (json['prediction_regions'] as List<dynamic>?)
              ?.map(
                (e) =>
                    PredictionRegionsModel.fromJson(e as Map<String, dynamic>),
              )
              .toList() ??
          [],
    );
